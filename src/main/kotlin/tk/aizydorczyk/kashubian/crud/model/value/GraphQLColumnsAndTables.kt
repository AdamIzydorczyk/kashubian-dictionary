...
class GraphQLColumnsAndTables {
    companion object {
        ...
        fun meaningHyponyms() =
            DSL.field(DSL.select(Routines.findHyponyms(meaningTable().ID)))

        fun meaningHyperonyms() =
            DSL.field(DSL.select(Routines.findHyperonyms(meaningTable().ID)))
        ...
        fun entryDerivatives() =
            DSL.field(DSL.select(Routines.findDerivatives(entryTable().ID)))

        fun entryBasesWithAlias() = DSL.field(DSL.select(Routines.findBases(entryTable().ID))).`as`("entry_bases")
        fun entryBases() = DSL.field(DSL.select(Routines.findBases(entryTable().ID)))

        fun meaningsCount() = DSL.field(DSL.selectCount().from(Tables.MEANING)
