...
class KashubianEntryControllerValidationTest extends BaseTest {
    ...
    def "should return status 400 and WORD_NOT_UNIQUE message"() {
        given:
        def requestBody = asJsonString("json/post_put_entry_non_unique_word.json")
    ...
    def "should return status 400 and PART_OF_SPEECH_AND_SUBTYPE_INCONSISTENT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_inconsistent_types.json")
    ...
    def "should return status 400 and INCORRECT_NOUN_VARIATION_JSON_FORMAT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_incorrect_noun_variation.json")
    ...
    def "should return status 400 and INCORRECT_VERB_VARIATION_JSON_FORMAT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_incorrect_verb_variation.json")
    ...
    def "should return status 400 and INCORRECT_ADJECTIVE_VARIATION_JSON_FORMAT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_incorrect_adjective_variation.json")
    ...
    def "should return status 400 and INCORRECT_NUMERAL_VARIATION_JSON_FORMAT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_incorrect_numeral_variation.json")
    ...
    def "should return status 400 and INCORRECT_NOUN_PRONOUN_VARIATION_JSON_FORMAT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_incorrect_noun_pronoun_variation.json")
    ...
    def "should return status 400 and INCORRECT_ADJECTIVE_PRONOUN_VARIATION_JSON_FORMAT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_incorrect_adjective_pronoun_variation.json")
    ...
    def "should return status 400 and INCORRECT_ADVERB_VARIATION_JSON_FORMAT message"() {
        given:
        def requestBody = asJsonString("json/post_entry_incorrect_adverb_variation.json")
    ...
    def "should return status 400 and VARIATION_IS_NOT_NULL message"() {
        given:
        def requestBody = asJsonString("json/post_entry_not_null_variation.json")
    ...
    def "should return status 400 and ENTRY_NOT_EXISTS message"() {
        given:
        def requestBody = asJsonString("json/post_entry_base_not_exists.json")
    ...
    def "should return status 400 and MEANING_NOT_EXISTS message"() {
        given:
        def requestBody = asJsonString("json/post_entry_hyperonym_not_exists.json")
    ...
    def "should return status 400 and NOT_CONTAINS_AT_LEAST_ONE_MEANING message"() {
        given:
        def requestBody = asJsonString("json/post_entry_no_meanigs.json")
    ...
    def "should return status 400 and HYPERONIM_IDS_REPEATED_IN_MEANINGS message"() {
        given:
        def requestBody = asJsonString("json/post_entry_hyperonyms_repeated.json")
    ...
    def "should return status 400 and MEANING_OF_UPDATED_ENTRY message"() {
        given:
        def requestBody = asJsonString("json/put_entry_self_assign_meaning.json")
    ...
    def "should return status 400 and IS_UPDATED_ENTRY message"() {
        given:
        def requestBody = asJsonString("json/put_entry_self_assign.json")
    ...
    def "should return status 400 and IN_UPDATED_ENTRY_DERIVATIVES message"() {
        given:
        def requestBody = asJsonString("json/put_entry_assign_to_derivative.json")
    ...
    def "should return status 400 and IN_UPDATED_ENTRY_BASES message"() {
        given:
        def requestBody = asJsonString("json/put_entry_assign_to_base.json")
    ...
    def "should return status 400 and HYPERONIM_ID_IN_UPDATED_ENTRY_MEANINGS_HYPERONIMS message"() {
        given:
        def requestBody = asJsonString("json/put_meaning_assign_to_hyperonym.json")
    ...
    def "should return status 400 and IN_UPDATED_ENTRY_MEANINGS_HYPONIMS message"() {
        given:
        def requestBody = asJsonString("json/put_meaning_assign_to_hyponym.json")
